...
function DiagramStep2() {
    ...
    const shulchanContentMahoz = (
        <>
            ...
            5.  קיום שיח שוטף עם קמב"ץ מרכז האוכלוסייה.
        </>
    );
    ...
    const explanations = selectedOption === 'נפה' ? [
        ...
        },
        {
            ...
            text: [
                ...
                "4. יוביל מקצועית את פורום מדיניות התגוננות )החרגות( במחוז ,המתקיים בראשות מפקד המחוז.",
                "5. יוביל מקצועית את פורום מיצוי יכולות המרחב במחוז ,המתקיים בראשות סגן מפקד המחוז.",
                "6.  מנחה מקצועי לתאי מכלול אוכלוסיה בנפות.",
            ]
        }
    ];
...
style={{ backgroundColor: selectedOption === 'נפה' ? 'rgb(145 197 213' : 'rgb(243 209 158)' }}
            ...
            <div className='footer-DiagramStep2'></div>
